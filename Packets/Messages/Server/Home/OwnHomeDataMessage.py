...
class OwnHomeDataMessage(Writer):
    ...
    def encode(self):
        ...
        self.writeBoolean(False)  # Brawl Pass Purchased
        ...
        self.writeString(f"<cff9281>Твой токен: {self.player.token}\nFreezz Brawl 1.5Beta\Делись токеном только с администрацией!</c>") # Notification Message Entry
        self.writeVint(0)
        ...
        self.writeInt(604800) # Notification Time Ago
        ...
        for x in range(40):
            ...
            self.writeVint(50) # Brawler Trophy Loss
