...
class BattleResultShowdownMessage(Writer):
    ...
    def encode(self):
        ...
        if self.player.tutorial <= 1:
            ...
            exp_reward = [150, 120, 90, 60, 50, 40, 30, 20, 10, 0]
            token_list = [340, 280, 220, 160, 120, 80, 60, 40, 20, 0]
            practice_exp_reward = [80, 60, 50, 30, 30, 20, 20, 10, 10, 0] 
            practice_token_list = [170, 140, 110, 80, 60, 40, 30, 20, 10, 0]
            mvp_exp_reward = [100]
        # Trophy Balance
